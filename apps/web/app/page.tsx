  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F5F4F0] to-[#ECEAE7] dark:from-[#1A1A1A] dark:to-[#0F0F0F]">
          ...
          <div className="flex items-center space-x-4">
            {!loading && user ? (
              <div className="flex items-center space-x-4">
                <Link
                  href="/workspace"
                  className="px-6 py-2.5 bg-gradient-to-t from-[#8B70F6] to-[#9D7DFF] hover:from-[#7E64F2] hover:to-[#8B70F6] text-white font-medium rounded-2xl transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B70F6] focus:ring-offset-2 font-sans"
                >
                  Open Workspace
                </Link>
                <Link
                  href="/account/logout"
                  className="px-6 py-2.5 bg-white dark:bg-[#262626] border border-[#E0E0E0] dark:border-[#404040] text-[#121212] dark:text-white font-medium rounded-2xl hover:bg-[#FAF9F7] dark:hover:bg-[#333333] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B70F6] focus:ring-offset-2 font-sans"
                >
                  Sign Out
                </Link>
              </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-12">
            {!loading && user ? (
              <Link
                href="/workspace"
                className="px-8 py-4 bg-gradient-to-t from-[#8B70F6] to-[#9D7DFF] hover:from-[#7E64F2] hover:to-[#8B70F6] text-white font-semibold text-lg rounded-2xl transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B70F6] focus:ring-offset-2 font-sans"
              >
                Open Workspace
              </Link>
            ) : (
              <>
                ...
                <Link
                  href="/account/signin"
                  className="px-8 py-4 bg-white dark:bg-[#262626] border border-[#E0E0E0] dark:border-[#404040] text-[#121212] dark:text-white font-semibold text-lg rounded-2xl hover:bg-[#FAF9F7] dark:hover:bg-[#333333] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B70F6] focus:ring-offset-2 font-sans"
                >
                  Sign In
                </Link>
              </>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center bg-white dark:bg-[#1E1E1E] rounded-3xl p-12 border border-[#E0E0E0] dark:border-[#404040]">
          ...
          {!loading && user ? (
            <Link
              href="/workspace"
              className="inline-flex px-8 py-4 bg-gradient-to-t from-[#8B70F6] to-[#9D7DFF] hover:from-[#7E64F2] hover:to-[#8B70F6] text-white font-semibold text-lg rounded-2xl transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#8B70F6] focus:ring-offset-2 font-sans"
            >
              Open Workspace
            </Link>
          ) : (
      ...
      <footer className="py-8 px-6 border-t border-[#E0E0E0] dark:border-[#404040] bg-white/50 dark:bg-[#1E1E1E]/50">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm text-[#666666] dark:text-[#AAAAAA] font-sans">
